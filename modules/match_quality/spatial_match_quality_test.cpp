...
void wideCoverageMatchesAreNotNarrowClusters()
{
    ...
    const auto quality =
        pfm::match_quality::evaluateSpatialMatchQuality(makeWideMatches(), {1000.0, 1000.0}, {1000.0, 1000.0}, options);
...
{
    const auto quality =
        pfm::match_quality::evaluateSpatialMatchQuality(makeNarrowCluster(), {1000.0, 1000.0}, {1000.0, 1000.0});
...
void repeatedPointsRemainStableAndClustered()
{
    ...
    const auto quality = pfm::match_quality::evaluateSpatialMatchQuality(matches, {800.0, 600.0}, {800.0, 600.0});
...
{
    const auto quality =
        pfm::match_quality::evaluateSpatialMatchQuality(makeNarrowCluster(), {0.0, 1000.0}, {1000.0, -1.0});
...
{
    register_test("spatial match quality empty set reports zeros and not suspicious",
                  emptySetReportsZerosAndNotSuspicious);
    ...
    register_test("spatial match quality repeated points remain stable and clustered",
                  repeatedPointsRemainStableAndClustered);
