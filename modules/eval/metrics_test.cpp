...
{
    register_test("matching_precision_counts_matches_within_threshold",
                  matching_precision_counts_matches_within_threshold);
    register_test("matching_precision_returns_zero_for_empty_predictions",
                  matching_precision_returns_zero_for_empty_predictions);
    register_test("matching_precision_accepts_undefined_points_a", matching_precision_accepts_undefined_points_a);
    register_test("matching_precision_rejects_shape_mismatch", matching_precision_rejects_shape_mismatch);
    register_test("matching_precision_rejects_integer_predicted_b_dtype",
                  matching_precision_rejects_integer_predicted_b_dtype);
    register_test("semi_dense_coverage_uses_valid_mask_area", semi_dense_coverage_uses_valid_mask_area);
    register_test("semi_dense_coverage_returns_zero_for_empty_valid_mask",
                  semi_dense_coverage_returns_zero_for_empty_valid_mask);
    register_test("semi_dense_coverage_rejects_shape_mismatch", semi_dense_coverage_rejects_shape_mismatch);
    register_test("semi_dense_coverage_rejects_undefined_confidence", semi_dense_coverage_rejects_undefined_confidence);
    register_test("semi_dense_coverage_rejects_integer_confidence_dtype",
                  semi_dense_coverage_rejects_integer_confidence_dtype);
    register_test("half_turn_consistency_counts_cross_image_matches", half_turn_consistency_counts_cross_image_matches);
    register_test("half_turn_mean_error_measures_distance_from_rotated_target",
                  half_turn_mean_error_measures_distance_from_rotated_target);
    register_test("half_turn_consistency_rejects_non_positive_image_size",
