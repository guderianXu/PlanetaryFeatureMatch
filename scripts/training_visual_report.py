...
def parse_args() -> argparse.Namespace:
    ...
    if args.graph_max_attention_layers < 0:
        parser.error("--graph-max-attention-layers must be nonnegative; use 0 to keep all graph layers")
